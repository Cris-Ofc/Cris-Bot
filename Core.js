...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./Assets/pic10.jpg'), `${watermark}`, `${BotName}`, "923474187615@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
            ...
            if (isMedia && m.msg.fileSha256 && (m.msg.fileSha256.toString('base64') in global.db.sticker)) {
              ...
              const textImg = (teks) => {
                ...
                const fgi = {
                  ...
                  { remoteJid: "923474187615-1613049930@g.us" } : {}) 
                               },
                  message: { 
                                "videoMessage": { 
                                "title": `Cris`,
                                ...
                                'gifPlayback': 'true', 
                                'caption': `Asif`,
                                'jpegThumbnail': fs.readFileSync('./Assets/cris.mp4')
                                       }
                                      }
                                   } 
...
const ftroli = {
  ...
  "message": {
  "groupInviteMessage": {
  "groupJid": "923474187615-1616169743@g.us",
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Hello ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Asif to take your WhatsApp usage into next level.
        
       「 𝚂𝚈𝚂𝚃𝙴𝙼 𝙸𝙽𝙵𝙾 」
    
    🝮︎︎︎︎︎︎︎𝗦𝗽𝗲𝗲𝗱 : ${latensie.toFixed(4)} miliseconds
    🝮︎︎︎︎︎︎︎𝗨𝗽 𝗧𝗶𝗺𝗲 : ${runtime(process.uptime())}
    🝮︎︎︎︎︎︎︎𝗕𝗼𝘁 𝗡𝗮𝗺𝗲 : ${global.BotName}
    🝮︎︎︎︎︎︎︎𝗢𝘄𝗻𝗲𝗿 𝗡𝗮𝗺𝗲 : ${global.OwnerName}
    🝮︎︎︎︎︎︎︎𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : Amazon AWS
    🝮︎︎︎︎︎︎︎𝗧𝗼𝘁𝗮𝗹 𝗨𝘀𝗲𝗿 : ${Object.keys(global.db.users).length}
    
    
       「 𝚄𝚂𝙴𝚁 𝙸𝙽𝙵𝙾 」
    
    🝮︎︎︎︎︎︎︎𝗨𝘀𝗲𝗿 𝗟𝗲𝘃𝗲𝗹: ${levelMenu}
    🝮︎︎︎︎︎︎︎𝗨𝘀𝗲𝗿 𝗫𝗽    : ${xpMenu} \ ${reqXp}
    🝮︎︎︎︎︎︎︎𝗨𝘀𝗲𝗿 𝗥𝗼𝗹𝗲  : ${role}
    
    
       「 𝚄𝚂𝙴𝚁 𝙱𝙰𝙽𝙺 」
    
    🝮︎︎︎︎︎︎︎𝗨𝘀𝗲𝗿 𝗕𝗮𝗹𝗮𝗻𝗰𝗲 : ${uangku}
    🝮︎︎︎︎︎︎︎𝗜𝗿𝗼𝗻 : ${getBesi(m.sender)}
    🝮︎︎︎︎︎︎︎𝗚𝗼𝗹𝗱 : ${getEmas(m.sender)}
    🝮︎︎︎︎︎︎︎𝗘𝗺𝗮𝗿𝗮𝗹𝗱 : ${getEmerald(m.sender)}
    🝮︎︎︎︎︎︎︎𝗣𝗼𝘁𝗶𝗼𝗻 : ${getPotion(m.sender)}
    
    
    Type *.menu* or press any button below to start using *${global.BotName}*
    
    ©️ *${global.BotName}* All Rights Reserved by: *Asif*
    `
...
for (let anju of xeonyaudio){
	...
	if (smallinput.includes('bot')) {
	 ...
	 if (smallinput.includes('Asif') || smallinput.includes('@923474187615')){
        reply (`*My Boss is lost in another Multiverse, I lost contact with him...*`)
    }
	
	

    if( smallinput.includes('Hi') || smallinput.includes('hi') || smallinput.includes('Hey') || smallinput.includes('hey')){
      reply (`hey ${pushname}, I am ${BotName}. How can i help you?`);
    }
    

    if (smallinput.includes('good morning') || smallinput.includes('Morning')) {
      reply (`Good morning to you too ${pushname} ☺️. Have a great day 😇.`);
    }

	
	if (smallinput.includes('good affternoon')) {
    ...
    if (smallinput.includes('thanks')|| smallinput.includes('thank you') || smallinput.includes('thank')) {
...
case 'support': case 'supportgc':
    ...
    reply(`*My developer's group:* https://chat.whatsapp.com/FRAdKkqDtYl98n1gtvob04`)
    break

case 'repo': case 'botrepo':
    
    reply(`My Source Code is - https://github.com/Cris-Ofc`)
    break
...
case 'limituser': case 'userlimit': case 'limit':
            ...
            {      
               let txt = `「 *𝙰𝙻𝙻 𝚄𝚂𝙴𝚁 𝙻𝙸𝙼𝙸𝚃* 」\n\n`
                 for (let i of _limit){
                 txt += ` *𝗨𝘀𝗲𝗿 𝗜𝗗 :* @${i.id.split("@")[0]}\n🝮︎︎︎︎︎︎︎ *Limit* : ${i.limit}\n`
                 }
                reply(txt)       
              }
             break
...
await A17.sendMessage(m.chat, { delete: key })
 ...
 let teks = ` 「  CRIS 𝙿𝙼 𝚄𝚂𝙴𝚁 𝙻𝙸𝚂𝚃  」\n\nTotal ${anu.length} users are using Cris-Bot in personal chat.`
 for (let i of anu) {
  teks += `\n\n💛Profile : @${i.id.split('@')[0]}\n💬Chat : ${i.unreadCount}\n🗨️Lastchat : ${moment(i.conversationTimestamp * 1000).tz("Asia/Kolkata").format("DD/MM/YYYY HH:mm:ss")}`
 }
 A17.sendTextWithMentions(m.chat, teks, m)
 }
 break
...
case 'happymod': {
 ...
 let teks = '```「 YOᑌTᑌᗷᗴ Տᗴᗩᖇᑕᕼ ᗴᑎᘜIᑎᗴ 」```\n\n Search Term: '+text+'\n\n'
 let no = 1
...
let mentioned = participants.map(v => v.jid)
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "923474187615@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
     } else if (sizny > 20) {
     await A17.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
     replay("Joined !")
     } else {
...
if (isBanChat) return reply(mess.bangc)
 ...
 try {
 A17.sendMessage(from, {image:{url:args[0]}, caption:"Success!"}, {quoted:m})  } catch {
 reply("Link error")
 }
 }
 break
...
if (isBanChat) return reply(mess.bangc)	             
             if (!text) return reply(`Please provide link!`)
                ...
                xfarrapi.Twitter(`${text}`).then(async (data) => {                    
                    ...
                    txt += `🎗️*Size :* ${data.medias[1].formattedSize}\n`
                    txt += `☄️*Duration :* ${data.medias.length}\n`
                    txt += `💠*URL :* ${data.url}\n\n`
                    txt += `*${BotName}*`
...
case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
 ...
 {buttonId: `.ytvd ${text}`, buttonText: {displayText: '🎞️ Video'}, type: 1}

 ]
 let buttonMessage = {
 image: { url: anu.thumbnail },
 caption: `「  _CRIS Youtube Player 2.0_  」

*🧊Title :* ${anu.title}

*🏵️Duration :* ${anu.timestamp}
*🧿Viewers :* ${anu.views}
*🧸Uploaded :* ${anu.ago}
...
*🧃Url :* ${anu.url}`,
 ...
 A17.sendMessage(from, {video:{url:ytmp4play.videoUrl}, mimetype:"video/mp4", caption:anu.title+' By *cris MD*',}, {quoted:m})
 }
 break
 ...
 let buttonMessage = {
 image: { url: anu.thumbnail },
 caption: `「  CRIS Youtube Downloader 2.0  」
...
*🍐Url :* ${anu.url}`,
 ...
 A17.sendMessage(from, {video:{url:ytmp4play2.videoUrl}, mimetype:"video/mp4", caption:'Downloaded by *cris MD*',}, {quoted:m})
 }
 break
...
case 'swm': case 'take': case 'stickerwm': case 'steal':{
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
if (!args.join(" ")) return reply(`Use command: .steal Cris|By: Asif`)
const swn = args.join(" ")
...
const { Anime } =require("@shineiichijo/marika")
   ...
   let details = `🧊*Title:* ${result.title}\n`;
    ...
    details += `👁️*Based on:* ${result.source.toUpperCase()}\n`;
    details += `🐟*Studios:*\n`;
...
│───────────────────────│
┠🝮︎︎︎︎︎︎︎│▸ I am *𝗖𝗥𝗜𝗦-𝗕𝗢𝗧*, a Bot Developed by *Asif*.
│───────────────────────│
│╭────────────────···▸
┠─────═[ *𝗧𝗢𝗗𝗔𝗬* ]═────
│╰────────────────···▸
│╭────────────────···▸
┴│▸. 𝁘𝂅⬎̸͇ᥲᥣᰓ⃪͛᷼ᦵ⃪᭯ᰫ᭮💜⬎̸ 𝙰𝚂𝙸𝙵✨
🝮︎︎︎︎︎︎︎│▸ *𝙏𝙞𝙢𝙚* : -----${Waktu}
┬│▸  💙⟵꯭꯭᪵〬𝐌𐍂꯭꯭.Ꮭϴ𝐕𝐄⎯꯭̽❤
│╰────────────────···▸
┠───═[ *𝗕𝗢𝗧 𝗜𝗡𝗙𝗢* ]═──▸
│╭────────────────···▸
┴│▸ 
🝮︎︎︎︎︎︎︎│▸ *𝘽𝙤𝙩 𝙐𝙨𝙚𝙧 𝙉𝙖𝙢𝙚 :* ${pushname} 
🝮︎︎︎︎︎︎︎│▸ *𝙈𝙮 𝙋𝙧𝙚𝙛𝙞𝙭 𝙄𝙨 :*  ${prefix}
🝮︎︎︎︎︎︎︎│▸ *𝙊𝙬𝙣𝙚𝙧 𝙉𝙖𝙢𝙚 :* ${global.OwnerName} 
🝮︎︎︎︎︎︎︎│▸ *𝘽𝙤𝙩 𝙎𝙥𝙚𝙚𝙙 :* ${latensie.toFixed(4)} ms 
🝮︎︎︎︎︎︎︎│▸ *𝘽𝙤𝙩 𝙍𝙪𝙣𝙩𝙞𝙢𝙚 :* ${runtime(process.uptime())} 
🝮︎︎︎︎︎︎︎│▸ *𝙋𝙡𝙖𝙩𝙛𝙤𝙧𝙢 :* Linux 
┬│▸ Ⲏꫀɑⲅⲧ Ⲏɑᥴᴋꫀ𝗿 🍁
│╰────────────────···▸
┠🝮︎︎︎︎︎︎︎│▸ 𝑯𝒆𝒓𝒆'𝒔 𝑻𝒉𝒆 𝑳𝒊𝒔𝒕 𝑶𝒇 𝑴𝒚 𝑪𝒐𝒎𝒎𝒂𝒏𝒅𝒔.🝮︎︎︎︎︎︎︎
│╭────────────────···▸
│╰────────────────···▸
┠─━━〈 ⚙️ *𝗖𝗢𝗥𝗘* ⚙️ 〉━━
│╭────────────────···▸
...
🝮︎︎︎︎︎︎︎│▸ .antilinktg
🝮︎︎︎︎︎︎︎│▸ .antilinktt
🝮︎︎︎︎︎︎︎│▸ .antilinkytch
🝮︎︎︎︎︎︎︎│▸ .antilinkvid
🝮︎︎︎︎︎︎︎│▸ .antilinkig
🝮︎︎︎︎︎︎︎│▸ .antilinkfb
🝮︎︎︎︎︎︎︎│▸ .antilinktwit
🝮︎︎︎︎︎︎︎│▸ .antilinkall
🝮︎︎︎︎︎︎︎│▸ .antiwame
┬│▸
╰────────────────···▸
...
🝮︎︎︎︎︎︎︎│▸ .couple
🝮︎︎︎︎︎︎︎│▸ .soulmate
🝮︎︎︎︎︎︎︎│▸ .handsomecheck
🝮︎︎︎︎︎︎︎│▸ .beautifulcheck
🝮︎︎︎︎︎︎︎│▸ .awesomecheck
🝮︎︎︎︎︎︎︎│▸ .greatcheck
🝮︎︎︎︎︎︎︎│▸ .gaycheck
🝮︎︎︎︎︎︎︎│▸ .cutecheck
🝮︎︎︎︎︎︎︎│▸ .uglycheck
🝮︎︎︎︎︎︎︎│▸ .charactercheck
🝮︎︎︎︎︎︎︎│▸ .lesbiancheck
🝮︎︎︎︎︎︎︎│▸ .hornycheck
🝮︎︎︎︎︎︎︎│▸ .prettycheck
🝮︎︎︎︎︎︎︎│▸ .lovelycheck,
┬│▸
...
│╭───────────────···▸
┴│▸
🝮︎︎︎︎︎︎︎│▸ 🍁 Type " *${prefix}nsfw* " then enable NSFW (Admin only!) 
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸ 🍁 Then type " *${prefix}nsfwmenu* " for all NSFW commands.
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸ 『  *${global.BotName}*  』
🝮︎︎︎︎︎︎︎│▸    Developed By: *Asif*
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸ 🌹 To use any of these commands type 
🝮︎︎︎︎︎︎︎│▸ " *${prefix}<Command name>* ".
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸ 🌹 To get Support Group link type " *${prefix}support* ".
🝮︎︎︎︎︎︎︎│▸
🝮︎︎︎︎︎︎︎│▸ 🌹 Type " *${prefix}help* " to get full command list.`
 ...
 let buttonshelpm = [
    {buttonId: `.owner`, buttonText: {displayText: 'Bot Owner'}, type: 1}
                ...
                let buttonMessage = {
                    video:fs.readFileSync('./system/cris_2.mp4'),gifPlayback:true,
                    caption: helpmenu,
                    footer: `${BotName}`,
...
case '':
 ...
 const needhelpmenu = `Do you need help ${pushname} bro? Type *${prefix}help* to get my full command list.`
     
         let butRun = [
                {buttonId: `.help`, buttonText: {displayText: 'Help'}, type: 1}
                ]
                let buttonMessage = {
                    video:fs.readFileSync('./system/Cris.mp4'),gifPlayback:true,
...
default:
    ...
    if(isCmd){
        if (isBan) return reply(mess.banned)	 			
        if (isBanChat) return reply(mess.bangc)
        reply (`No such command programmed *${pushname}* bro! Type *${prefix}help* to get my full command list!`)
